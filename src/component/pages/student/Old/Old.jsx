...
export default function New() {
  ...
  async function joinRequest(value) {
    ...
    try {
      const { data } = await axios.post("http://localhost:5000/api/student/old", formData, {
      ...
      console.log("خطأ في العملية", err.response.data.message);
  ...
  const [formData, setFormData] = useState({
    ...
    guardian_phone_number: "", //An Egyption
    ...
    dormTypeWithoutFood: 0, // قيمة افتراضية
        ...
        <div className="container mb-5">
          <div className="row">
            <div className="d-flex mt-3 ">
              <div className="egyption ms-5">
                <input
                  ...
                  checked={isEgyption}
                  required // هذه الخاصية تجعل الحقل مطلوبًا
                />
              ...
              <div className="noegyption">
                <input
                  ...
                  required // هذه الخاصية تجعل الحقل مطلوبًا
                />
                <label htmlFor="noegyption">وافد</label>
              </div>
            </div>
            ...
            <Fragment>
                  ...
                  <div className=" row mt-3">
                    <div className=" col  ">
                      ...
                      <input
                        ...
                        required // هذه الخاصية تجعل الحقل مطلوبًا
                      />
                      {formikObj.errors.passport_number && formikObj.touched.passport_number && (
                        <div className="alert alert-danger">{formikObj.errors.passport_number}</div>
                      )}
                    </div>
                  </div>
                  <div className=" col  ">
              ...
              <div className="row ">
                ...
                <div className="col">
                  ...
                  >
                    ...
                    <option value="الاولي"> الاولى</option>
              ...
              <div className="row mt-3">
                <div className="col">
                  <label htmlFor="branch">  تقدير العام الماضى</label>
                  <select
                    id="branch"
                    className="form-control w-50"
                ...
                <div className="col-3">
                  ...
                  <input
                    ...
                    name="Total_grades_high_school"
                    value={formData.Total_grades_high_school}
                    onChange={handleChange}
                  />
              ...
              <div className="row mt-3">
                <div className="col">
                  ...
                  <select
                    id="skan"
                    className="form-control w-50"
                    name="housing_type" // تغيير اسم الحقل إلى housing_type
                    onChange={handleChange}
                  >
                ...
                <div className="col d-flex align-items-center gap-3">
                  <label htmlFor="meal">  تغذيه </label>
                  <input
                    className="form-check-input"
                    type="checkbox"
                    id="dormTypeWithoutFood"
                    name="dormTypeWithoutFood"
                    onChange={() =>
                      setFormData({
                        ...formData,
                        dormTypeWithoutFood: !formData.dormTypeWithoutFood ? 1 : 0, // إعادة تعيين القيمة بناءً على قيمتها الحالية
                      })
                    }
                    checked={formData.dormTypeWithoutFood === 1} // تحقق مما إذا كانت القيمة 1 لتحديد الخانة في حالة الحاجة
                  />
