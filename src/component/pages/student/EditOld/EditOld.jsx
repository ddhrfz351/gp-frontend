...
export default function New() {
  ...
  const [formData, setFormData] = useState({
    ...
    father_phone_number: "", //An Egyption
  ...
  async function fetchData() {
    try {
      ...
      const responseData = response.data; // الاستجابة الكاملة
      const studentData = responseData.studentData;
      console.log(studentData); // بيانات الطالب المطلوبة
      ...
      setFormData(prevData => ({
        ...
        issuing_authority: studentData.issuing_authority,
        nationality: studentData.nationality,
        national_id: studentData.national_id,
        student_id: studentData.student_id || prevData.student_id,
        ...
        detailed_address: studentData.detailed_address,
        father_name: studentData.father_name,
        father_occupation: studentData.father_occupation,
        father_phone_number: studentData.father_phone_number,
        residence_address: studentData.residence_address,
        guardian_national_id: studentData.guardian_national_id,
        guardian_relationship: studentData.guardian_relationship,
        guardian_phone: studentData.guardian_phone,
        guardian_states: studentData.guardian_states,
        parents_status: studentData.parents_status,
        college: studentData.college, // تأكد من تحديث حقل الكلية
        Secondary_Division: studentData.Secondary_Division,
        special_needs: studentData.special_needs,
        password: studentData.password,
        university_name: studentData.university_name,
        confirm_password: studentData.confirm_password,
        father_name: studentData.father_name,
        ...
        guardian_phone: studentData.guardian_phone,
        guardian_states: studentData.guardian_states,
        previous_academic_year_gpa: studentData.previous_academic_year_gpa,
        high_school_department_from_abroad: studentData.high_school_department_from_abroad,
        family_from_abroad: studentData.family_from_abroad,
        special_needs: studentData.special_needs,
      }));
          ...
          <div className="row">
            ...
            <Fragment>
              ...
              <div className="form-group">
                <label htmlFor="name" style={{ marginBottom: '0.5rem', display: 'block', fontWeight: 'bold' }}>الاسم</label>
                <input
                  type="text"
                  id="name"
                  name="name"
              ...
              <div className="row mt-3">
                ...
                <div className="col">
                  <label htmlFor="mobile_number">التليفون</label>
                  <input
                    type="number"
                    id="phone"
                    className="form-control w-50"
              ...
              <div className="row ">
                ...
                <div className="col">
                  ...
                  >
                    ...
                    <option value="الفرقه الاولى">الفرقه الاولى</option>
                    <option value="الفرقه الثانية">الفرقه الثانية</option>
                    <option value="الفرقه الثالثة">الفرقه الثالثة</option>
                    <option value="الفرقه الرابعة">الفرقه الرابعة</option>
              ...
              <div className="row mt-3">
                <div className="col">
                  <label htmlFor="Secondary_Division">شعبة الثانوية العامة</label>
                  <select
                    id="Secondary_Division"
                    className="form-control w-50"
              ...
              <div className="row mt-3">
                ...
                <div className="col-3">
                  <label htmlFor="percent"> نسبة التقدير</label>
                  <input
                    type="text"
                    className="form-control w-50 percent"
                    name="previous_academic_year_gpa"
                    value={formData.previous_academic_year_gpa}
                    onChange={handleChange}
                  />
